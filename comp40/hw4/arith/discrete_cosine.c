 ...
 * SCALING_FACTOR_A provided from assignment document for unsigned 9-bit int
 * SCALING_FACTOR_BCD calculated for signed 5-bit int in range of -15...15
 * calculated using 15.5 / .3 > SCALING_FACTOR_BCD 
 */
const float SCALING_FACTOR_A = 511.0;
const float SCALING_FACTOR_BCD = 50.0;
